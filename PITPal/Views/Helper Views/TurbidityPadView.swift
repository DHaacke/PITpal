...
struct TurbidityPadView: View {
    ...
    var body: some View {
        VStack {
            ...
            HStack {
                NumberedButtonView(enteredNumber: $enteredNumber, buttonText: "MAX")
...
#Preview {
    ...
    TurbidityPadView(isPresented: $isPresented, enteredNumber: $enteredNumber)
